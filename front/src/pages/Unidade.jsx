...
function Unidade() {
  ...
  // 3. NOVA FUNÇÃO: Enviar o cadastro para o Banco (POST)
  const lidarComCadastro = (e) => {
    ...
    .then(instituicaoSalva => {
      ...
      // Pegamos todas as unidades que já tínhamos e "colamos" a nova no final
      ...
      <div className="flex flex-col gap-2">
        {listaFiltrada.map((item) => (
          <div key={item.id} className="bg-white p-4 rounded-lg shadow-sm border border-gray-200 flex justify-between items-center">
            ...
            <button className="p-2 text-gray-500 hover:text-blue-600 hover:bg-gray-100 rounded-full cursor-pointer">
